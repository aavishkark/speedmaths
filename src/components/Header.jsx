...
import { IconBook, IconLightning, IconReverse, IconTimer, IconUser } from "./Icons";
    ...
    <header className="app-header">
      <div className="header-left">
        <div className="header-brand">
          ...
          <span className="app-brand-title">CAT Speed Math</span>
        </div>

        {/* Integrated Clean Mode Switcher */}
        <div className="header-mode-nav" role="tablist" aria-label="Study mode">
          {DRILL_MODES.map((drillMode) => {
            ...
            return (
              <button
                ...
                className={`header-mode-btn ${isActive ? "active" : ""}`}
                onClick={() => onModeChange(drillMode.id)}
              >
                <Icon size={14} />
                <span>{drillMode.label}</span>
              </button>
            );
          })}
        </div>
      ...
      <div className="header-controls">
        <button
          ...
          type="button"
          title="Open CAT Speed Math Blueprint (6-Page Cheat Sheet)"
        >
          <IconBook size={14} />
          <span>Blueprint</span>
        </button>
