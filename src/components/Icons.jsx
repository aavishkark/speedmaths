...
export function IconReverse({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M1 4v6h6" />
...
export function IconTimer({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconFlame({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2c-.5 2-2 4-4 6-2.5 2.5-4 5.5-4 8.5C4 20.5 7.5 23 12 23s8-2.5 8-6.5c0-3-1.5-6-4-8.5-2-2-3.5-4-4-6zm0 18c-2.5 0-4.5-1.5-4.5-3.8 0-1.8 1.2-3.5 2.7-4.8.4-.3.9.1.8.6-.2 1.2.3 2.4 1.3 3.1.8.6 1.7.9 2.7.9 1 0 1.8-.4 2.3-1.1.2-.3.6-.4.8-.1.5.8.7 1.7.7 2.6 0 2.3-2 3.8-4.5 3.8z" />
    </svg>
  );
}
...
export function IconCross({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconAward({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconStar({ size = 16, className = "", filled = false }) {
  return (
...
export function IconSparkles({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2L14.39 8.26L21 9.27L16 14.14L17.18 21.02L12 17.77L6.82 21.02L8 14.14L3 9.27L9.61 8.26L12 2Z" opacity="0.4" />
      <path d="M9 22L9.9 19.1L12.7 18.2L9.9 17.3L9 14.5L8.1 17.3L5.3 18.2L8.1 19.1L9 22Z" />
    </svg>
  );
}
...
export function IconCalculator({ size = 16, className = "" }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
